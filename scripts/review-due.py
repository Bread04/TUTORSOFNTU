...
Parses the LEDGER.md table and reports what is due for retrieval practice,
ordered so the most valuable items come first: longest overdue, then weakest.
Pure date arithmetic. It makes no judgement about what is worth teaching --
that stays with the agent.

Intervals widen with strength (days):
    0 -> 1    taught, not yet demonstrated
    1 -> 2    shaky, heavy scaffolding
    2 -> 4    solved with hints
    3 -> 9    solved cold once
    4 -> 21   solved cold repeatedly
    5 -> 60   uses it unprompted / can teach it back
